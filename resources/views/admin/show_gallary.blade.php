             ...
             @endif
              ...
              <div class="row">
                ...
                <div class="text-center mt-1">
                    <p style="font-size: 2vw;" class="c-title">Show Gallary Image</p>
                ...
                <table class="table table-striped  tbl_center" id="myTable">
                  ...
                  @foreach( $gallary as $item)
                    <tr>
                      <td>
                      <img  src="/gallaryImage/{{$item->image}}"  style="height:50px;width:50px;">
                      </td>
                      <td>
                         <a onclick="return confirm('Are You Sure to Delete this Product ? ')" href="{{ url('delete_gallary', $item->id)}}" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
                  @endforeach
                  </tbody>
