<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
      <a class="sidebar-brand brand-logo" href="{{ url('/redirect')}}"><b style="font-size:2vw; color:#c5d4c9;text-decoration:none;">D.I.Y RENTALS</b></a>
    </div>
    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{ url('view_order')}}">
          ...
          <span class="menu-title">Orger Request</span>
        </a>
      </li>
